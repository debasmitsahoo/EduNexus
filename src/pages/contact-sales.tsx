        ...
        <div className="container mx-auto px-4 py-12">
          ...
          <div className="max-w-2xl mx-auto">
            <div className="text-center mb-12">
              <h1 className="text-4xl font-bold text-navy-blue mb-4">Contact Sales</h1>
              <p className="text-lg text-gray-600">
                Get in touch with our sales team to discuss custom pricing and solutions for your institution.
              </p>
            </div>
