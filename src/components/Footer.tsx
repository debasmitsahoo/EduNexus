...
import { GraduationCap, Mail, Phone, MapPin, ArrowRight, Facebook, Twitter, Instagram, Linkedin, Youtube, Github } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              <a 
                href="https://github.com/debasmitsahoo/EduNexus" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-deep-yellow transition-colors"
